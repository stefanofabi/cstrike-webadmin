				...
				<form class="form-horizontal" method="post" onsubmit="return updateRank();">
					...
					<div class="row mb-5">
						<div class="col-9">
							...
							<input type="text" class="form-control" placeholder="{{ trans('ranks.enter_name') }}" name="name" id="modal_rank_name" required>
						</div>

						<div class="col-9 mt-3">
							<label for="auth"> <h5> <strong> {{ trans('ranks.price') }}: </strong> </h5> </label>
							
							<input type="number" class="form-control" placeholder="{{ trans('ranks.enter_price') }}" name="price" id="modal_rank_price" step="0.1" required>
						</div>

						<div class="col-9 mt-3">
							<label for="name"> <h5> <strong> {{ trans('ranks.purchase_link') }}: </h5> </strong> </label>
							
							<input type="text" class="form-control" name="purchase_link" id="modal_rank_purchase_link" value="{{ @old('purchase_link') }}">
						</div>

						<div class="col-9 mt-3">
							<label for="auth"> <h5> <strong> {{ trans('ranks.color') }}: </strong> </h5> </label>
							
							<input type="color" class="form-control" name="color" id="modal_rank_color" required>
						</div>
