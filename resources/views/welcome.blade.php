                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"> {{ trans('welcome.rules') }} </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"> {{ trans('welcome.vigilance') }} </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"> {{ trans('welcome.friendly') }} </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"> {{ trans('welcome.diversity') }}</div>
                            </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('buy_administrator') }}" class="ml-1 underline">
                            ...
                            <a href="https://github.com/stefanofabi/cstrike-webadmin#contribuyendo" target="_blank" class="ml-1 underline">
                                Sponsor
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        <a href="https://4evergaming.com.ar" target="_blank" class="ml-1 underline">
                            {{ trans('welcome.designed_by') }}
                        </a> 
                    </div>
                </div>
            </div>
