...
return [
    ...
    */
    ...
    'diversity_message' => 'Los mensajes de contenido racista y/o discriminatorio están absolutamente prohibidos: los responsables de esta comunidad creen en la igualdad y el respeto absoluto entre los seres humanos basado en la diversidad cultural, cualquiera que sea su condición social o nacionalidad.',
    'rules' => 'Reglas',
    'rules_message' => 'El desconocimiento total o parcial de las reglas no exime a la persona de culpa. Depende de ustedes, los usuarios, leer o no las reglas. No se aceptarán excusas de desconocimiento o falta de lectura de este. Las reglas deben aceptarse fuera de la comunidad, incluso en la vida real.',
    ...
    'go_to_administration_panel' => 'Ir al Panel de Administración',
    'go_to_admin_panel' => 'Ir al panel Admin',
